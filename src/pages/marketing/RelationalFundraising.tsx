 ...
 * WHY: Positions Transitus as a relationship-first alternative — with basic generosity records.
 */
...
const EXAMPLES = [
  {
    ...
    body: "Pastor Sarah didn't track donations. She tracked conversations. Transitus helped her remember who offered their garage, who knew a produce distributor, and who had driven the same route for three years. The pantry grew because the relationships were already there — she just needed a way to remember them.",
  },
  {
    icon: Users,
    title: 'A refugee resettlement org finds housing partners',
    body: "When families arrived, the team didn't need a fundraising thermometer. They needed to know which landlords had shown compassion before, which volunteers spoke Dari, and which church had offered a welcome dinner last spring. Transitus remembered what spreadsheets forgot.",
  },
  {
    icon: Globe,
    title: 'A digital inclusion nonprofit grows through presence',
    body: "They never sent a fundraising appeal. Instead, they showed up — at community meetings, at library events, at school board sessions. Transitus captured those moments as reflections, building a narrative of presence that eventually attracted three anchor partners without a single ask.",
  },
];
...
const STRUCTURED_DATA = {
  ...
  description: 'How Transitus supports generosity through presence, relationships, and basic giving records — not donation management.',
  author: { '@type': 'Organization', name: 'Transitus' },
  publisher: { '@type': 'Organization', name: 'Transitus', url: 'https://transitus.app' },
};
...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Does Transitus track donations?',
      acceptedAnswer: { '@type': 'Answer', text: 'Transitus includes basic generosity records — date, amount, recurring status, and a note — so you can honor the people who give. But it is not a donor management system. There are no campaigns, pledges, tax receipts, or donor scores.' },
    },
    {
      '@type': 'Question',
      name: 'How does Transitus support fundraising without being a donor CRM?',
      acceptedAnswer: { '@type': 'Answer', text: 'Transitus helps organizations remember people, capture relationship moments, and build narrative around community engagement. Basic giving records provide relational context — honoring generosity as part of a person\'s story, not as a transaction to manage.' },
    },
  ],
};
...
export default function RelationalFundraising() {
  useEffect(() => {
    document.title = 'Fundraising Without a Donor CRM | Transitus';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Transitus includes basic generosity records to honor giving — but it is not a donor CRM. Learn how relationship memory replaces donor management.');
    else {
      const m = document.createElement('meta');
      m.name = 'description';
      m.content = 'Transitus includes basic generosity records to honor giving — but it is not a donor CRM. Learn how relationship memory replaces donor management.';
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <header className="text-center mb-16">
          ...
          <p className="text-base sm:text-lg text-[hsl(var(--marketing-navy)/0.6)] leading-relaxed max-w-xl mx-auto">
            Transitus™ includes basic generosity records — but it is not a donor management system.
            <br />
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 text-sm sm:text-base text-[hsl(var(--marketing-navy)/0.65)] leading-relaxed">
            ...
            <p>
              Transitus was built on a different premise: <strong className="text-[hsl(var(--marketing-navy))]">if you remember the people, the generosity follows.</strong> Not because you tracked it. Because you earned it.
            </p>
          </div>
        </section>

        {/* Section 2: Generosity in Transitus */}
        <section className="mb-16">
          <h2
            className="text-xl sm:text-2xl font-semibold text-[hsl(var(--marketing-navy))] mb-4"
            style={serif}
          >
            What Transitus Does — and What It Doesn't
          </h2>
          <div className="space-y-4 text-sm sm:text-base text-[hsl(var(--marketing-navy)/0.65)] leading-relaxed mb-8">
            <p>
              Transitus includes <strong className="text-[hsl(var(--marketing-navy))]">basic generosity records</strong> — date, amount, whether it's recurring, and a personal note. These records live on a person's profile as relational context, not as financial data to manage.
            </p>
            <p>
            ...
            <p>
              Instead, Transitus gives you <strong className="text-[hsl(var(--marketing-navy))]">relationship memory</strong>. Every reflection, every event attended, every conversation captured becomes part of a living narrative — and generosity is simply one thread in that story.
            </p>
          </div>
        ...
        <section className="mb-16">
          <div className="rounded-xl bg-[hsl(var(--marketing-surface))] border border-[hsl(var(--marketing-border))] p-6 sm:p-8">
            ...
            <p className="text-sm text-[hsl(var(--marketing-navy)/0.6)] leading-relaxed mb-3">
              Transitus doesn't replace your donor CRM — it complements it. With Transitus Bridge™, you can sync contacts and relationship data from platforms like Bloomerang, DonorPerfect, Little Green Light, NeonCRM, and CiviCRM. Generosity records from these systems flow into Transitus as read-only relational context.
            </p>
            <p className="text-sm text-[hsl(var(--marketing-navy)/0.55)] leading-relaxed italic">
              Your donor CRM handles the receipts. Transitus holds the relationships.
            </p>
          </div>
        </section>
