/**
 * manualData — Structured data for the Transitus Field Guide and Gardener Steward Manual.
 *
...
export const SIGNAL_TYPES: SignalEntry[] = [
  ...
  { signal_type: 'sync_conflict_detected', trigger_event: 'Bi-directional sync detects conflicting field values between Transitus and external CRM', visible_surface: 'Integrations page (Steward)', operator_visibility: 'Nexus Migrations' },
  { signal_type: 'outbound_sync_completed', trigger_event: 'Transitus data successfully written back to external CRM (Dynamics 365 or Salesforce)', visible_surface: 'Integration sync log', operator_visibility: 'N/A (tenant-only)' },
...
export const AI_DISCERNMENT_CONTENT: AiDiscernmentSection[] = [
  ...
  },
  {
    ...
    body: 'Your data belongs to your organization. Period.\n\nTransitus enforces a strict boundary around every tenant workspace:',
    bullets: [
