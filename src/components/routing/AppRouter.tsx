    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/:tenantSlug" element={<ProtectedRoute><TenantRouteGuard /></ProtectedRoute>}>
          ...
          <Route path="admin/how-to" element={<AdminHowTo />} />
          <Route path="admin/flocknote" element={<FlocknoteImportWizard />} />
          <Route path="admin/do-not-email" element={<DoNotEmail />} />
          <Route path="admin/email-providers" element={<EmailProviders />} />
          <Route path="admin/guided-activation" element={<GuidedActivationPrep />} />

          {/* Catch-all: redirect unmatched tenant sub-paths to tenant index */}
