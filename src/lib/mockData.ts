...
export const MOCK_PLACES: Place[] = [
  ...
  },
  {
    ...
    human_impact_summary: '45,000 residents \u2014 a majority-Latino immigrant community \u2014 live directly under the flight path of one of the nation\u2019s busiest airports. Families report nosebleeds, headaches, and sleeplessness. Children grow up unable to play outside during peak flight hours. Coastal flooding threatens to displace the same families already harmed by aviation pollution.',
...
export const MOCK_COMMUNITY_STORIES: CommunityStory[] = [
  ...
  },
  {
    ...
    place_id: 'place-1',
    story: 'Tomasz worked at the steel mills for 22 years before they closed. He and Ewa bought their home in 1994 and have paid it off. Now the petroleum terminal 800 feet from their back fence operates around the clock. The smell wakes them at night. Their property value has dropped 40% since the terminal expanded. They can\u2019t sell and can\u2019t afford to move. "We did everything right," Ewa says. "We worked, we saved, we paid the mortgage. And now we\u2019re trapped."',
    ...
    quote: 'We did everything right. We worked, we saved, we paid the mortgage. And now we\u2019re trapped.',
  ...
  },
  {
    ...
    place_id: 'place-3',
    story: 'Four generations of the Reyes family have lived within a mile of the Crawford Coal Plant. Grandmother Lucia remembers when the coal dust would coat the windowsills by afternoon. Her daughter Carmen had chronic bronchitis. Her granddaughter Sofia was born premature \u2014 doctors said environmental factors were likely involved. The plant closed in 2012, but Sofia still uses an inhaler. "They took the plant down," Carmen says, "but they can\u2019t take down what it did to us."',
    health_impacts: ['chronic_bronchitis', 'premature_birth', 'asthma', 'lead_exposure'],
    years_in_community: 68,
    family_context: 'Four-generation family. Grandmother, mother, adult daughter, two grandchildren.',
    quote: 'They took the plant down, but they can\u2019t take down what it did to us.',
    consent_level: 'public',
    collected_by: 's-8',
  ...
  },
  {
    ...
    place_id: 'place-2',
    story: 'Ahmed and Fatima immigrated from Somalia 8 years ago. They chose East Boston because of the Somali community and affordable rents. Now their rent has doubled and luxury condos are going up on the waterfront. Meanwhile, their apartment floods every major storm \u2014 three times in the past two years. Ahmed works nights at the airport that makes their children sick. "We came here for safety," Fatima says. "We found a different kind of danger."',
    health_impacts: ['mold_exposure', 'stress', 'respiratory_illness'],
    years_in_community: 8,
    family_context: 'Immigrant family. Father works at Logan Airport. Mother, three school-age children.',
    quote: 'We came here for safety. We found a different kind of danger.',
  ...
  },
  {
    ...
    place_id: 'place-1',
    story: 'Reverend Okonkwo has served St. Kevin\u2019s for 9 years. He buries people who died too young from cancers his parishioners attribute to the industrial corridor. "I\u2019ve done 14 funerals this year," he says. "Eight were under 70. Three were under 50. People ask me why God lets this happen. I tell them God didn\u2019t put that refinery next to our homes. People with power did. And people with power can move it."',
    ...
    quote: 'God didn\u2019t put that refinery next to our homes. People with power did. And people with power can move it.',
    consent_level: 'public',
    collected_by: 's-10',
  ...
  },
  {
    ...
    place_id: 'place-3',
    story: 'Lupita runs a taqueria on 26th Street. She\u2019s watched the neighborhood change for 20 years. The coal plant closed, which was a victory. But now warehouses and logistics companies are moving in, bringing diesel trucks that idle on residential streets while drivers wait for loading slots. "We got rid of one poison and they replaced it with another," she says. "The trucks come through at 5 AM. My customers\u2019 kids walk to school through the exhaust."',
    ...
    quote: 'We got rid of one poison and they replaced it with another. The trucks come through at 5 AM. My customers\u2019 kids walk to school through the exhaust.',
    consent_level: 'public',
    collected_by: 's-7',
