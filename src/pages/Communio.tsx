...
import { useQuery as useRoleQuery } from '@tanstack/react-query';
...
export default function Communio() {
  ...
  // Check if tenant has a public profile already
  ...
  const { data: isSteward } = useRoleQuery({
    queryKey: ['user-is-steward', user?.id],
    queryFn: async () => {
  ...
  return (
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <CommunioSoftInvite isSteward={!!isSteward} />
