...
import { HelpCircle, ChevronRight, ChevronLeft, Check, Loader2, Church, Building2, GraduationCap, Users, Heart, Library, Home, Landmark, Compass, HandHeart, MapPin, Shield, BookOpen, Upload, FileText, Sparkles, X, Globe, Eye, EyeOff, Mail, CheckCircle2 } from 'lucide-react';
...
const STEPS = ['account_creation', 'welcome', 'steward_welcome', 'archetype', 'relational_focus', 'sectors', 'ministry_role', 'multi_city', 'territory', 'details', 'knowledge', 'org_enrichment', 'familia', 'confirm'] as const;
...
export default function Onboarding() {
  ...
  const isCheckoutReturn = checkoutToken === 'success' || hasStripeSessionId;
