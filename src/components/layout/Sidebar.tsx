...
const navGroups: NavGroup[] = [
  ...
  {
    labelKey: 'sidebar.groups.outreach',
    icon: Mail,
    items: [
  ...
  {
    labelKey: 'sidebar.groups.relatio',
    icon: Plug,
    items: [
...
// Items that appear after groups but before "other" items
          ...
          <div className="space-y-1">
            ...
            {!isVisitor && navGroups
              .filter(g => {
                ...
                if (g.labelKey === 'sidebar.groups.outreach' && isWarehouseManager) return false;
                if (g.labelKey === 'sidebar.groups.outreach' && !showOutreach) return false;
              ...
              .map(group => {
                ...
                if (group.labelKey === 'sidebar.groups.partners' && inboxCount && inboxCount > 0) {
                  enriched = {
                    ...enriched,
            ...
            {/* Post-group standalone items */}
            {!isVisitor && prefixItems(postGroupItems).map(item => renderNavItem(item, showLabel))}
