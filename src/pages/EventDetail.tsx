    ...
    return (
      <NotFoundWrapper>
        <div className="text-center py-12">
          ...
          <Button onClick={() => navigate(isOperatorRoute ? '/operator/events' : '/events')}>
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          <Button variant="ghost" onClick={() => navigate(isOperatorRoute ? '/operator/events' : '/events')} className="gap-2 self-start">
